        ...
        <section className="py-20 bg-secondary/10 dark:bg-background-dark">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              {/*Strawberry lychee*/}
              <div className="bg-background-light dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 p-6">
                <h3 className="text-2xl font-bold text-text-dark dark:text-text-light mb-4">Strawberry Lychee</h3>
                <p className="text-text-dark/70 dark:text-text-light/70 mb-4 leading-relaxed">
              ...
              <div className="bg-background-light dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 p-6">
                <h3 className="text-2xl font-bold text-text-dark dark:text-text-light mb-4">Strawberry ShortCake</h3>
                <p className="text-text-dark/70 dark:text-text-light/70 mb-4 leading-relaxed">
              ...
              {/*Dubai Chocolate*/}
              <div className="bg-background-light dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 p-6">
                <h3 className="text-2xl font-bold text-text-dark dark:text-text-light mb-4">Dubai Chocolate</h3>
                <p className="text-text-dark/70 dark:text-text-light/70 mb-4 leading-relaxed">
                 Black Raspberry Chip- Raspberry infused ice cream layered with dark chocolate chips.
                  Biscoff- Vanilla ice cream infused with Biscoff
